...
import { getTiposNegocio } from "../../../services/tiposNegocio.service";
            ...
            <div className="overflow-y-auto pr-2">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 w-full max-w-sm">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            return (
                                ...
                                className={`px-3 py-1.5 rounded-full text-sm border transition-all
                                    ...
                                    ${
                                    isSelected
                                        ? "bg-emerald-500 text-white border-emerald-500 shadow scale-105"
                                        : "bg-white text-stone-600 border-stone-200 hover:border-emerald-400 hover:scale-105"
                                    }
                                `}
                                >
                                {isSelected ? (
                        ...
                        <input
                            type="hidden"
                            {...register("tags", { required: "Selecciona al menos uno" })}
                        />
