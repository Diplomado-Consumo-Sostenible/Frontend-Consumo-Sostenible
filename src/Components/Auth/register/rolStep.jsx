...
export default function RoleStep({ onSelectRole }) {
  return (
    <div className="flex-1 bg-white/80 backdrop-blur-xl flex flex-col justify-center px-10 py-10">
      <BackButton />
      <div className="mb-8">
        <h1 className="text-stone-800 text-2xl font-semibold">¿Cómo deseas registrarte?</h1>
        <p className="text-stone-400 text-sm mt-1">Elige el tipo de cuenta que quieres crear</p>
      </div>
      ...
      <div className="grid gap-6">
        ...
        >
          <div
            className="w-12 h-12 flex items-center justify-center rounded-xl bg-emerald-50 
          ...
          <div className="text-left">
            ...
            <p className="text-sm text-stone-400">Explora y utiliza la plataforma</p>
          </div>
        </button>
        ...
        >
          ...
          <div className="text-left">
            ...
            <p className="text-sm text-stone-400">Registra tu establecimiento</p>
          </div>
        </button>
      </div>
    </div>
