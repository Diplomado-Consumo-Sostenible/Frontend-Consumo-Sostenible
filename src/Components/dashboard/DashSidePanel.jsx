import { Award, Lightbulb, Map as MapIcon, MapPin, Recycle, ShoppingBag, Store } from 'lucide-react';
...
const TIPS = [
  ...
  { Icon: Recycle,     text: 'Guarda tus favoritos para acceder fácilmente'             },
...
export default function DashSidePanel({ businesses }) {
  return (
