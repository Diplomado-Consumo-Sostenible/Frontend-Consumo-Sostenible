// Layout reutilizable para las pantallas de autenticación.
// Maneja el fondo, los blobs decorativos y el contenedor de dos columnas.
// Recibe el panel hero y el formulario como props para ser reutilizable
// en Login, Register, ForgotPassword, etc.
export default function AuthLayout({ hero, form }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-stone-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Contenedor de dos columnas: hero izquierda | form derecha */}
