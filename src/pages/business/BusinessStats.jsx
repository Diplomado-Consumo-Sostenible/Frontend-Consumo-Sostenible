  ...
  return (
    <div className="pl-14 pr-6 py-6 space-y-8 w-full">
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted mt-0.5">Métricas y rendimiento de tu negocio · Próximamente</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3 px-4 py-3 bg-primary-softest border border-edge rounded-2xl">
        ...
        <p className="text-sm text-primary-dark">Esta sección está en desarrollo. Pronto podrás ver métricas detalladas de tu negocio.</p>
      </div>

      <div>
        <p className="text-xs font-semibold text-muted uppercase tracking-wider mb-3">Resumen</p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {STAT_CARDS.map((card) => (
            <div key={card.label} className="bg-card-bg rounded-2xl border border-edge shadow-sm p-4 space-y-3 opacity-60">
